...
export const useBusinessSettings = () => {
  const DEFAULT_SETTINGS: BusinessSettings = {
    ...
    phone: "+91 7045339273",
    email: "classicchinese@gmail.com",
    isGstEnabled: true,
    cgstRate: 2.5,
    sgstRate: 2.5,
    kitchenPin: "1234",
    ...
    landingPageContent: {
      ...
      about_description: "Classic Chinese brings authentic Chinese dining culture to you. From classic dim sums to sizzling hot main courses, we serve happiness in every bite.",
      about_cards: [
      ...
      why_choose_us_title: "Why Choose <span class='text-secondary'>Classic Chinese</span>",
      why_choose_us_cards: [
      ...
      gallery_title: "A Glimpse of <span class='text-primary'>Classic Chinese</span>",
      gift_voucher_title: "Gift a Dining Voucher 🧧",
      gift_voucher_description: "Surprise someone special with a Classic Chinese gift voucher. Choose any amount starting from ₹100, customize the code, and share it instantly via WhatsApp!",
      menu_title: "OUR MENU",
