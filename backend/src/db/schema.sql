...
CREATE TABLE public.hero_content (
    ...
    description text DEFAULT 'Traditional flavors. Sizzling wok dishes. Fresh ingredients. Experience the finest culinary journey at Classic Chinese.'::text NOT NULL,
    image_url text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE TABLE public.location_content (
    ...
    instagram_handle text DEFAULT '@classicchinese'::text NOT NULL,
    instagram_url text DEFAULT 'https://www.instagram.com/classicchinese'::text NOT NULL,
